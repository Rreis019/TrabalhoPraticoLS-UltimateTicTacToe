...
function Tabuleiro(props){
    ...
    if(props.gameManager.boardWin[props.index] === -1){
      for(let i = 0; i < 9; i++) {celulas.push(<Celula index={i} key={i} tableIndex={props.index} selected={props.selected} gameManager={props.gameManager} setGameManager={props.setGameManager}/>);}
    }
    else{
